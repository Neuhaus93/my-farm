...
<div class="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
	<!-- Card -->
	<div class="rounded-xl bg-white p-4 shadow dark:bg-neutral-800 sm:p-7">
		<div class="mb-8">
			...
			<div class="grid gap-2 sm:grid-cols-12 sm:gap-6">
				...
				<div class="sm:col-span-3">
					...
					<div class="hs-tooltip inline-block">
						...
						<span
							class="hs-tooltip-content invisible absolute z-10 inline-block w-40 rounded bg-gray-900 px-2 py-1 text-center text-xs font-medium text-white opacity-0 shadow-sm transition-opacity hs-tooltip-shown:visible hs-tooltip-shown:opacity-100 dark:bg-neutral-700"
							role="tooltip"
						>
				...
				<div class="sm:col-span-9">
					<div class="sm:flex">
						<input
							...
							type="text"
							class="relative -ms-px -mt-px block w-full border-gray-200 px-3 py-2 pe-11 text-sm shadow-sm first:rounded-t-lg last:rounded-b-lg focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 sm:mt-0 sm:first:ms-0 sm:first:rounded-s-lg sm:first:rounded-se-none sm:last:rounded-e-lg sm:last:rounded-es-none"
							placeholder="Maria"
						/>
						<input
							type="text"
				...
				<div class="sm:col-span-9">
					<input
						id="af-account-email"
						type="email"
						class="block w-full rounded-lg border-gray-200 px-3 py-2 pe-11 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
					...
					<div class="sm:flex">
						...
						>
							<input
								...
								class="mt-0.5 shrink-0 rounded-full border-gray-300 text-blue-600 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-500 dark:bg-neutral-800 dark:checked:border-blue-500 dark:checked:bg-blue-500 dark:focus:ring-offset-gray-800"
				...
				<div class="sm:col-span-9">
					<textarea
						id="af-account-bio"
						class="block w-full rounded-lg border-gray-200 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
						rows="6"
